...
def dashboard_manageuser_test(driver: Chrome) -> None:
    target_site = 'http://localhost:5000/signup'
    driver.get(target_site)
    
    credentials = dict(
    email='yuchen.jiang01@gmail.com',
    password='yuchenjiang'
    )
	
    #signup_director(driver, credentials)
    #signin_director(driver, credentials)
    ...
    find = driver.find_element_by_id('mainNav')
    find.click()
...
def dashboard_messageusers_test(driver: Chrome) -> None:
